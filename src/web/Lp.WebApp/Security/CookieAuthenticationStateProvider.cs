...
{
    public class CookieAuthenticationStateProvider(IHttpClientFactory _client, IUserManager _userManager) : AuthenticationStateProvider, ICookieAuthenticationStateProvider
    {
        private bool _isAuthenticated = false;
        private readonly HttpClient _client = _client.CreateClient(ConstantsConfiguration.HTTP_CLIENT_NAME);
        private readonly IUserManager _userManager = _userManager;
