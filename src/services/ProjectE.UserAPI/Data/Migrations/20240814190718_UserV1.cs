...
namespace HealthLife.UserAPI.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityStamp = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersRoleClaim", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersRole_NormalizedName",
                table: "UsersRole",
